      ...
      <div className="p-6 sm:p-8 md:p-12 lg:p-16">
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
          {t.about.benefits.map((benefit: string, index: number) => (
            <li
              key={index}
              className="flex items-center gap-2 sm:gap-3 text-primary text-base sm:text-lg p-4 sm:p-6 bg-section-secondary rounded-lg border border-standard shadow-standard"
            >
